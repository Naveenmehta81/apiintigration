...
const Home = () => {
  return (
    <div className="min-h-[calc(100vh-4rem)] w-full overflow-x-hidden bg-gradient-to-br from-purple-500 to-pink-500 flex flex-col justify-center items-center p-10">
      <div className="w-full text-center space-y-8">
        {/* Badge */}
        <div className="inline-block bg-blue-100 text-blue-700 py-1 px-4 rounded-full text-sm font-bold tracking-wide mb-4">
          🚀 New Stock Arrived!
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-10">
          <Link
            to="/product"
            className="px-8 py-4 bg-orange-600 text-white text-lg font-bold rounded-full shadow-lg hover:bg-orange-700 transition w-full sm:w-auto"
          >
            Browse Products
          </Link>
          <Link
